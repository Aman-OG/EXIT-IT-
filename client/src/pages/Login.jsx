    ...
    <div className="min-h-screen flex items-center justify-center bg-background px-4 py-12 relative overflow-hidden">
      ...
      <div className="max-w-md w-full bg-card rounded-[32px] border border-text/10 shadow-2xl p-8 sm:p-10 space-y-6 relative z-10">
        ...
        <div className="text-center pt-2">
          <h2 className="text-3xl font-black font-outfit tracking-tight">Log In</h2>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <button 
            type="submit" 
            disabled={isLoading}
            className="w-full bg-text text-background py-3.5 rounded-xl text-xs font-black uppercase tracking-widest hover:opacity-90 transition-all disabled:opacity-50 flex items-center justify-center space-x-2 group shadow-md"
          >
